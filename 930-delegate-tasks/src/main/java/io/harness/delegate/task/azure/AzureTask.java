  ...
  public DelegateResponseData run(TaskParameters parameters) {
    ...
    switch (azureTaskParams.getAzureTaskType()) {
      ...
      case LIST_SUBSCRIPTIONS:
        return azureNgHelper.listSubscriptions(
            azureTaskParams.getEncryptionDetails(), azureTaskParams.getAzureConnector());
      case LIST_RESOURCE_GROUPS:
        ...
        return azureNgHelper.listResourceGroups(azureTaskParams.getEncryptionDetails(),
      ...
      case LIST_CONTAINER_REGISTRIES: {
        ...
        return azureNgHelper.listContainerRegistries(azureTaskParams.getEncryptionDetails(),
            azureTaskParams.getAzureConnector(),
            azureTaskParams.getAdditionalParams().get(AzureAdditionalParams.SUBSCRIPTION_ID));
      }
      case LIST_CLUSTERS:
        ...
        return azureNgHelper.listClusters(azureTaskParams.getEncryptionDetails(), azureTaskParams.getAzureConnector(),
            azureTaskParams.getAdditionalParams().get(AzureAdditionalParams.SUBSCRIPTION_ID),
      ...
      case LIST_REPOSITORIES: {
        ...
        return azureNgHelper.listRepositories(azureTaskParams.getEncryptionDetails(),
            azureTaskParams.getAzureConnector(),
            azureTaskParams.getAdditionalParams().get(AzureAdditionalParams.SUBSCRIPTION_ID),
