...
public class VmInitializeTaskUtilsTest extends CIExecutionTestBase {
  ...
  public void getInitializeTaskParamsWithName() {
    ...
    VmPoolYaml vmPoolYaml = VmPoolYaml.builder()
                                .spec(VmPoolYamlSpec.builder().name(ParameterField.createValueField(poolName)).build())
                                .build();
  ...
  public void getInitializeTaskParamsWithId() {
    ...
    VmPoolYaml vmPoolYaml =
        VmPoolYaml.builder()
            .spec(VmPoolYamlSpec.builder().identifier(poolId).name(ParameterField.createValueField(null)).build())
            .build();
