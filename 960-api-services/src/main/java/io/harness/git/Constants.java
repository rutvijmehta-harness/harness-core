...
public interface Constants {
  ...
  String REPOSITORY_GIT_LOCK_DIR = "./repository/gitFileDownloads/locksTmpDir";
  String REPOSITORY_GIT_FILE_LOCK = "./repository/gitFileDownloads/locksTmpDir/interProcessFileLock_%s";
